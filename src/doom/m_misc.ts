// m_misc.ts — Miscellaneous utility functions

// M_Random - Returns a random number 0-255 from a pre-built table
// This is the exact table from the original Doom source
...
export function M_StringWidth(str: string, charWidth: number): number {
...
export function M_ClearBox(box: number[]): void {
	box[BOXTOP] = box[BOXRIGHT] = -0x7fffffff;
	box[BOXBOTTOM] = box[BOXLEFT] = 0x7fffffff;
}

export function M_AddToBox(box: number[], x: number, y: number): void {
